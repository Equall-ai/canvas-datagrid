...
export default function () {
  ...
  component.attributeChangedCallback = function (attrName, oldVal, newVal) {
    ...
    // Inline `on*="js source"` attributes are deliberately not supported: they
    // require compiling a string into a function, which throws under a
    // Content-Security-Policy without 'unsafe-eval'.  Attach handlers with
    // grid.addEventListener instead.
    return;
  };
